...
// ConvertRGBA uses the RGBA data from an image.Image to generate an Image which
// can be used throughout the library.
func ConvertRGBA(img image.Image) (*Image, error) {
...
// ConvertGray uses the grayscale data from an image.Image to generate an Image
// which can be used throughout the library.
func ConvertGray(img image.Image) (*Image, error) {
